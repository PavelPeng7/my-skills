...
def main() -> None:
    parser = argparse.ArgumentParser(description="Remove chroma key background and split sprites.")
    parser.add_argument("--input", required=True, help="Input image path")
    parser.add_argument("--output-dir", required=True, help="Output directory")
    parser.add_argument("--key-color", default="", help="Hex color, e.g. #00FF00. If omitted, sample corners.")
    parser.add_argument("--tolerance", type=int, default=70, help="Chroma match tolerance")
    parser.add_argument("--alpha-threshold", type=int, default=8, help="Alpha threshold used for splitting")
    parser.add_argument("--min-area", type=int, default=400, help="Minimum connected area to keep")
    parser.add_argument("--padding", type=int, default=8, help="Padding around crops")
    parser.add_argument("--names-file", default="", help="Optional one-name-per-line file")
    parser.add_argument("--transparent-sheet-name", default="00_transparent_sheet.png")
    parser.add_argument("--manifest-name", default="manifest.json")
    parser.add_argument("--despill", action="store_true", help="Reduce green spill on preserved pixels")
